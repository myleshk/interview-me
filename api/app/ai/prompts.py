...
def build_system_prompt(context_chunks: list[str] | None = None) -> str:
    ...
    prompt = (
        ...
        "and your knowledge.\n\n"
        "Skill levels matter. A skill merely listed in a HIGHLIGHTS "
        "section is secondary — you have exposure but not necessarily "
        "deep expertise. Only claim real depth for skills explicitly "
        "backed by your work experience descriptions. If asked about "
        "a listed-only skill, honestly describe your actual level of "
        "experience rather than overstating it. Similarly, when asked "
        "which company you used a skill at, only answer if your "
        "knowledge explicitly states it — never infer or guess.\n\n"
